...
t1, I1 = np.loadtxt(path+"BlinkNeu1.csv", skiprows=1, unpack=True, delimiter=",")
t2, I2 = np.loadtxt(path+"BlinkNeu2.csv", skiprows=1, unpack=True, delimiter=",")
t3, I3 = np.loadtxt(path+"BlinkNeu3.csv", skiprows=1, unpack=True, delimiter=",")

bx = 104
img1 = mpimg.imread(path+"BlinkNeu1.png")[2*bx+20:3*bx+20,:,:]
img2 = mpimg.imread(path+"BlinkNeu2_2.png")[2*bx-50:3*bx-50,:,:]
img3 = mpimg.imread(path+"BlinkNeu3_3.png")[2*bx-10:3*bx-10,:,:]
ic(img1.shape)
...
#plt.show()
# plt.savefig("C:/Users/toni-/OneDrive/Alt/Desktop/Uni/Master/PPD/Versuche/EinzelmolekülSpek/Bilder/Blinken.pdf", 
#             bbox_inches="tight")