...
\begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{glas_spektrum1.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{glas_dispersion1.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.6\textwidth]{sil_spektrum1.png}
