...
\begin{document}
  \setlength{\parindent}{0em}
    \begin{titlepage}
        ...
        \vspace{2.5cm}
        {\Huge \textbf{Dünnfilmprozessierungstechniken und\\Weißlichtreflektometrie}\\}
        \vspace{2.5cm}
        ...
        \vspace{2cm}
        {\large \textbf{Versuchstermin: 28.02.2024}\\}
        {\large \textbf{Abgabetermin: 15.03.2024}\\}
        \vspace{2cm}
        {\large \textbf{Betreuer\\}}
        {\LARGE \textbf{Fabian Eller\\}}
        \vfill
    \end{titlepage}
